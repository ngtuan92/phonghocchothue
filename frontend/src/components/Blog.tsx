...
export default function Blog({ 
  ...
  return (
    <section id="blog" className={classNames("pb-0 sm:pb-16 scroll-mt-20", !noContainer && "main-container", isHomePage ? "home-blog-section pt-[72px] sm:pt-24 md:pt-24 lg:pt-24" : "pt-0")}>
