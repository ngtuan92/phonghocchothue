...
const Contact = () => {
  ...
  return (
    <div className="mt-10 sm:mt-36 mb-6 sm:mb-36 w-full p-6 main-container sm:p-20 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 justify-center justify-items-center">
      {imgUrl && (
        <Image
