...
const Contact = () => {
  ...
  return (
    <div className="mt-6 sm:mt-12 mb-6 sm:mb-12 w-full p-6 main-container sm:p-20 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 justify-center justify-items-center">
      {imgUrl && (
        <Image
